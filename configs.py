...
STREAM_LOGS = environ.get('STREAM_LOGS','-1002259804858')
SESSION = environ.get('SESSION','MissRozy')
CUSTOM_CAPTION = environ.get('CUSTOM_CAPTION')


class Config(object):
	API_ID = int(os.environ.get("API_ID", 20990520))
	API_HASH = os.environ.get("API_HASH", "714a70d62fc73bf8ec1a5d38adf8f198")
	BOT_TOKEN = os.environ.get("BOT_TOKEN","")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "mkfile_store01_bot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1002259804858))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "5797912002 8185007347"))
	...
	LAZY_PIC = os.environ.get("LAZY_PIC","https://envs.sh/Qd_.jpg https://envs.sh/Qzw.jpg https://envs.sh/Qzq.jpg")
